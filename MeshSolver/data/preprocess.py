...
if __name__ == '__main__':
    root = Path('dataset/IFCNetCoreObj')
    new_root = Path('dataset/IFCNetCoreObj_processed_500')
    png_old_root = Path('dataset/IFCNetCorePng')
    png_new_root = Path('dataset/IFCNetCorePng_processed_500')
    max_faces = 500
    ...
    for shape_dir in track(shape_list):
        ...
        # old_png = png_old_root / out_dir.relative_to(new_root).with_suffix(".png")
        # new_png = png_new_root / out_dir.relative_to(new_root).with_suffix(".png")
        # print(out_dir)
        # print(old_png)
        # print(new_png)
        ...
        # print(faces.shape[0])
        # if faces.shape[0] > max_face:
        #     max_face = faces.shape[0]
